...
INSERT INTO `cart` VALUES (1,1,'2024-01-01',5,NULL),(2,2,'2024-02-01',10,NULL),(3,3,'2024-03-01',15,NULL),(4,4,'2024-04-01',20,NULL),(5,5,'2024-05-01',25,NULL);
...
INSERT INTO `order` VALUES (1,1,1,'2024-01-01','2024-01-10',100.00,5.00,'Shipped',NULL),(2,2,2,'2024-02-01','2024-02-10',200.00,5.00,'Delivered',NULL),(3,3,3,'2024-03-01','2024-03-10',300.00,5.00,'Processing',NULL),(4,4,4,'2024-04-01','2024-04-10',400.00,5.00,'Cancelled',NULL),(5,5,5,'2024-05-01','2024-05-10',500.00,5.00,'Pending',NULL);
...
CREATE TABLE `review` (
  ...
  CONSTRAINT `review_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `review` VALUES (1,1,1,'Great product!',NULL),(2,2,2,'Good value for money.',NULL),(3,3,3,'Average quality.',NULL),(4,4,4,'Highly recommend.',NULL),(5,5,5,'Excellent!',NULL);
...
INSERT INTO `roles` VALUES (1,'Admin'),(2,'Customer'),(3,'Vendor');
...
CREATE TABLE `store` (
  ...
  CONSTRAINT `store_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `store` VALUES (1,1,1,'Store One',NULL),(2,2,2,'Store Two',NULL),(3,3,3,'Store Three',NULL),(4,4,4,'Store Four',NULL),(5,5,5,'Store Five',NULL);
...
INSERT INTO `user` VALUES (1,'John','Doe','john.doe@example.com','password1','1234567890'),(2,'Jane','Smith','jane.smith@example.com','password2','2345678901'),(3,'Mike','Brown','mike.brown@example.com','password3','3456789012'),(4,'Emily','Davis','emily.davis@example.com','password4','4567890123'),(5,'Sarah','Wilson','sarah.wilson@example.com','password5','5678901234'),(15,'Charukesh','Naiknaware','charukesh@123','123','8007870316'),(16,'Venkatesh','Naiknaware','venku@123','123','8007870316');
...
CREATE TABLE `user_roles` (
  ...
  KEY `RoleID` (`role_id`),
  CONSTRAINT `user_roles_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`ID`),
  CONSTRAINT `user_roles_ibfk_4` FOREIGN KEY (`user_id`) REFERENCES `user` (`ID`),
  CONSTRAINT `user_roles_ibfk_5` FOREIGN KEY (`user_id`) REFERENCES `user` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-15 13:51:42
